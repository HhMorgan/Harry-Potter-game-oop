...
//			Champion champ = champions.get(i);
//			if (i == 0) {
//				map[4][3] = new ChampionCell(champ);
//				((Wizard) champ).setLocation(new Point(4, 3));
//			} else if (i == 1) {
//				map[3][4] = new ChampionCell(champ);
//				((Wizard) champ).setLocation(new Point(3, 4));
//			} else if (i == 2) {
//				map[4][5] = new ChampionCell(champ);
//				((Wizard) champ).setLocation(new Point(4, 5));
//			} else {
//				map[5][4] = new ChampionCell(champ);
//				((Wizard) champ).setLocation(new Point(5, 4));
//			}
	...
	public void moveForward() throws IOException, OutOfBordersException, InvalidTargetCellException {
		...
		if (getMap()[newLocation.x][newLocation.y] instanceof CollectibleCell) {
			...
			game.encounterCollectible(((CollectibleCell) getMap()[newLocation.x][newLocation.y]).getCollectible());
		}
