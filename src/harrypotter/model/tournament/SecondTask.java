...
public class SecondTask extends Task {
	...
	public void encounterMerPerson() {
		...
		ArrayList<Point> merCells = new ArrayList<Point>();
		...
		if (currentX + 1 <= 9
			...
			merCells.add(new Point(currentX + 1,  currentY));
		...
		if (currentY - 1 >= 0
			...
			merCells.add(new Point(currentX,  currentY - 1));
		...
		getGame().setMerCells(merCells);
		getGame().setBlue(true);
